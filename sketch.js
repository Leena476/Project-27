...
function draw() {
  ...
  textFont("Arial");
  stroke("black");
  text("Newtons Cradle",275,40);
  
  fill("black");
  noStroke();
  textSize(15);
  text("Press the left arrow key to swing the first bob!",250,670);
  text("Press the right arrow key to swing the last bob!",246,685);
